...
[![Go Reference](https://pkg.go.dev/badge/github.com/JodeZer/twitter-scraper.svg)](https://pkg.go.dev/github.com/JodeZer/twitter-scraper)
...
```shell
go get -u github.com/JodeZer/twitter-scraper
```
...
import (
    "context"
    "fmt"
    twitterscraper "github.com/JodeZer/twitter-scraper"
)
